...
class QwenRealtimeASR:
        ...
        try:
            async for message in self.ws:
                ...
                if event_type == "conversation.item.input_audio_transcription.text":
                    ...
                    content = data.get("content", "") # The prompt says data structure has 'stash'. 
    ...
    async def transcribe_stream(self, audio_generator: AsyncGenerator[bytes, None]) -> AsyncGenerator[Dict[str, Any], None]:
        """
